...
## Exercise 4
Finally, lets make a ggplot!  Within `aes` assign x to x and y to y, use `anscombe_tidy` for data, and add `geom_point()`.  Assign your plot to `firstGGplot`
...
## Exercise 6
Now to draw each `group` in a seperate set of axis, use the facet_wrap function, specify that your `facet_wrap` makes 2 rows.
